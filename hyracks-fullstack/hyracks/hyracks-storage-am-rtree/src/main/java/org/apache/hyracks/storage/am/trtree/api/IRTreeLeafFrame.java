...
package org.apache.hyracks.storage.am.trtree.api;
...
public interface IRTreeLeafFrame extends IRTreeFrame {
    ...
    /**
     * Checks if the specified tuple can fit in the frame without requiring a page split.
     *
     * @param tuple The tuple to check.
     * @param cmp The comparator used to compare tuples.
     * @return true if the tuple can fit, false otherwise.
     * @throws HyracksDataException If there is an error during the process.
     */
    boolean checkIfFits(ITupleReference tuple, MultiComparator cmp) throws HyracksDataException;
